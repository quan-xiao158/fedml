...
from ..constants import (
    ...
    FedML_FEDERATED_OPTIMIZER_FEDBABU,
)
...
class SimulatorSingleProcess:
    def __init__(self, args, device, dataset, model, client_trainer=None, server_aggregator=None):
        ...
        from .sp.fedbabu import FedBabuAPI
        ...
        elif args.federated_optimizer == FedML_FEDERATED_OPTIMIZER_FEDBABU:
            self.fl_trainer = FedBabuAPI(args, device, dataset, model)
